...
export default class Stitch {
    ...
    static initializeDefaultAppClient(clientAppId: string, config?: StitchAppClientConfiguration): Promise<StitchAppClient>;
    static initializeAppClient(clientAppId: string, config?: StitchAppClientConfiguration): Promise<StitchAppClient>;
